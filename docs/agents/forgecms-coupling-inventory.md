...
| L4  | Next Data Cache tag `cms-content` + 300s TTL; nothing calls `revalidateTag` today.                                                                               | `src/lib/forgecms/execute-query.ts:3,12`                                                                       | Once externally reachable, decide whether to keep TTL, add revalidation, or move to ISR. Affects E1.                                                                           |
