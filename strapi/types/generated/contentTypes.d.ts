...
export interface ApiWpPageWpPage extends Struct.CollectionTypeSchema {
  collectionName: 'wp-pages';
  info: {
    description: 'Pages migrated from wordpress';
    displayName: 'wpPage';
    pluralName: 'wp-pages';
