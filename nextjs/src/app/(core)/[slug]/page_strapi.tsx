...
import { fetchStrapiGQL } from "@/lib/data/strapi"
import { pagesSlugs, pageSlugs, pageQuery } from "./pages.query"
...
export default async function Page(props: Props) {
  const strapiTest = await fetchStrapiGQL(pageSlugs)
  const { data: sanityTest } = await sanityFetch({
    query: pagesSlugs,
    perspective: "published",
    stega: false,
  })
  console.log("Strapi Slug Test:", strapiTest?.wpPages)
  console.log("Sanity Slug Test:", sanityTest)
